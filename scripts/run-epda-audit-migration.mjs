...
const sqlPath = join(repoRoot, 'docs/sql/2026-05-31_epda_customer_field_audit_postgres.sql')
...
try {
  ...
  console.log('[migrate] EPDA customer snapshot + field change audit schema ready')
} finally {
  await client.end()
}

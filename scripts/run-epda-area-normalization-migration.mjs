...
try {
  ...
  console.log(
    JSON.stringify(
      {
        before: {
          epda_parameter_set: beforeSet.rows[0]?.c ?? 0,
          epda_parameter_change_logs: beforeLog.rows[0]?.c ?? 0,
        },
        after: {
          epda_parameter_set: afterSet.rows[0]?.c ?? 0,
          epda_parameter_change_logs: afterLog.rows[0]?.c ?? 0,
        },
      },
      null,
      2,
